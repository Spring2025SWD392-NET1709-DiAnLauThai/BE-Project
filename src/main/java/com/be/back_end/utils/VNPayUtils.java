...
public class VNPayUtils {
    ...
    public  String generatePaymentUrlWithBookingId(String amount, String orderInfo, String orderType, HttpServletRequest request,String bookingcode) throws UnsupportedEncodingException {
        String vnp_Version = "2.1.0";
        String vnp_Command = "pay";
        String vnp_CurrCode = "VND";
        String vnp_Locale = "vn";
